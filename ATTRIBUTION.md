...
## @uswriting/exiftool (Apache-2.0)

- Version: 1.0.9
- License: Apache-2.0
- Note: Based on the original ExifTool by Phil Harvey (https://exiftool.org/)
- Original ExifTool License: Perl Artistic License or GPL-3.0 (dual-license)
...
- Version: 5.7.0
- Copyright: Various icon set authors
- License: MIT (package) with various icon set licenses
- Note: Bundles icons from multiple icon sets with their own licenses
...
- Version: 6.2.2
- Copyright: Valentin Hervieu
- License: MIT
- Source: https://github.com/ricardo-ch/react-easy-crop
...
1. Check the `/THIRD-PARTY` folder in this repository
2. Or check each package's `node_modules/[package-name]/LICENSE` file
3. Or visit each package's official GitHub repository
