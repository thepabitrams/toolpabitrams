...
type CropperInteractionSource = 'mouse' | 'touch' | 'wheel' | 'keyboard';
type CropperInteraction = {
...
declare class Cropper extends React.Component<CropperProps, State> {
  ...
  onDragStart: ({
    x,
    y
  }: Point, source: CropperInteractionSource) => void;
  onDrag: ({
    x,
    y
  }: Point) => void;
...
//#endregion
export { Area, CropperInteraction, CropperInteractionSource, type CropperProps, MediaSize, Point, Size, VideoSrc, Cropper as default, getInitialCropFromCroppedAreaPercentages, getInitialCropFromCroppedAreaPixels };
