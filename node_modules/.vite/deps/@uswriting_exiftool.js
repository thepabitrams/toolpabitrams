...
//#region node_modules/.pnpm/@uswriting+exiftool@1.0.9/node_modules/@uswriting/exiftool/dist/esm/index.js
...
async function T($) {
	...
	return e = new MemoryFileSystem({ "/": "" }), e.addFile("/exiftool", y), t = await ZeroPerl.create({
		fileSystem: e,
		stdout: (i) => {
